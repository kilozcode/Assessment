...
public class cucumberj {
	...
	public void the_User_details_are_entered_on_the_Create_UserScreen()  {
		...
		createPage.getUserName().sendKeys("kilozcode");
		createPage.getPassword().sendKeys("kilozpassword");
		createPage.getConPassword().sendKeys("kilozpassword");
		createPage.getFullName().sendKeys("Mr Kilo");
	}
